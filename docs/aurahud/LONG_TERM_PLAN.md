...
**Current execution plan:** [`DEMO_BUILD_PLAN.md`](./DEMO_BUILD_PLAN.md) — six polished demos built as separate slices, then ranked. Multiple can win. It supersedes the week-1 sequencing below while these phase gates still apply.
